...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2026 at 08:12 PM
...
-- Admin-managed lookup table for program categories.
--
...
--
-- Seed data for `program_category`
--
...
CREATE TABLE `requests` (
  ...
  `description` text DEFAULT NULL,
  `status` enum('pending','approved','rejected','validated') NOT NULL DEFAULT 'pending',
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
...
-- Admin-managed lookup table for transport categories.
-- Photos stored in /assets/images/types/, path saved as relative URL.
--
CREATE TABLE `transport_type` (
  `idTransportType` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `description` text DEFAULT NULL,
  `photo_url` varchar(255) DEFAULT NULL COMMENT 'Relative path inside assets/images/'
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
-- --------------------------------------------------------
--
-- Table structure for table `transport`
-- Normalized: uses idTransportType FK instead of hardcoded type string.
-- The `type` column is kept for backward-compat display but auto-synced from transport_type.name.
--
CREATE TABLE `transport` (
  ...
  `idTransportType` int(11) DEFAULT NULL COMMENT 'FK to transport_type'
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
-- --------------------------------------------------------
--
-- Table structure for table `trajet`
-- Includes geospatial metadata for Google Maps route visualization.
--
CREATE TABLE `trajet` (
  ...
  `depLat` double DEFAULT NULL COMMENT 'Departure latitude',
  `depLng` double DEFAULT NULL COMMENT 'Departure longitude',
  `depAddress` varchar(500) DEFAULT NULL COMMENT 'Departure full address',
  `destLat` double DEFAULT NULL COMMENT 'Destination latitude',
  `destLng` double DEFAULT NULL COMMENT 'Destination longitude',
  `destAddress` varchar(500) DEFAULT NULL COMMENT 'Destination full address'
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
-- --------------------------------------------------------
--
...
CREATE TABLE `ticket` (
  ...
  `user_id` int(11) NOT NULL,
  `idTrajet` int(11) NOT NULL,
  `citizenName` varchar(255) DEFAULT NULL COMMENT 'Passenger display name',
...
ADD PRIMARY KEY (`idTransport`),
  ADD KEY `fk_transport_type` (`idTransportType`);
--
...
--
-- Constraints for table `transport` (FK to transport_type)
--
ALTER TABLE `transport`
ADD CONSTRAINT `fk_transport_type` FOREIGN KEY (`idTransportType`) REFERENCES `transport_type` (`idTransportType`) ON DELETE
