<?php
/**
 * Transport.php — Model/Transport.php
 * Blueprint entity for a Transport vehicle.
...
class Transport {
    ...
    public function setIdTransportType(?int $id): void       { $this->idTransportType = $id; }
}
?>
